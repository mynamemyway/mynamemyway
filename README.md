...
## 🌐 Проекты над которым работаю сейчас

1. [PrimeNetworking](https://github.com/mynamemyway/prime-net-docs) (main business project - документация доступна для демонстрации).  
...
2. [Portfolio-AI](https://github.com/mynamemyway/portfolio-ai) - my pet project  
   https://t.me/portfolio_py_ai_bot  
...
3. Mr. Banners 2.0 - бизнес проект для типографии "ПИРАНЬЯ" [Piranha](https://mir-pr.ru/)  
   https://t.me/mir_piar_bot  
AI-Telegram bot в роли эксперта по печатной продукции и рекламе с быстрым калькулятором услуг агенства.  
Автономно на основе векторной базы знаний помогает клиентам оформить заказ и автоматизировать процессы работающего бизнеса.
<br/>

4. CRM + ERP система для управления заказами типографии "ПИРАНЬЯ" [Piranha](https://mir-pr.ru/)  
Система построенная на платформе Grist и включает в себя автоматизации, валидации, бизнес-логику и защиту от ошибок пользователей.
Гайд со скринами - [клик](https://github.com/mynamemyway/piranha-grist-db-docs)
<br/>

6. [Антошкин Дворик](https://github.com/mynamemyway/antoshkin-pwa-card) - Система цифровых дисконтных карт для цветочного комбината [https://card.rassada1.ru/](https://card.rassada1.ru)  
